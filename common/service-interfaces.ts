...
export interface ServiceWorkflow {
  run(request: ExternalPlaceholderRequest<any>, context: Context): Promise<ExternalPlaceholderResponse<any, any>>;
}
...
export interface ExternalPlaceholderResponse<TChoice, TOutput> extends ExternalAPIResponse {
  /**
...
export interface ContextualHook {
  run(body: any, context: Context): Promise<any>;
}

export interface GenericHook {
  run(request: HttpRequest, context: Context): Promise<any>;
}
